...
inputFile = './data/2.fitting_alignment-2.txt'
inputFile = 'C:/Users/Ashis/Downloads/dataset_248_5 (1).txt'
outputFile = './results/2.fitting_alignment.txt'
...
## max score node is the max in the last column
maxScore = float("-inf")
maxi = -1
for i in range(1,len1+1):
    if scores[i][len2] > maxScore:
        maxScore = scores[i][len2]
        maxi = i
